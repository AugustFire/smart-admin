...
| 🍽️ 饮食记录 | 饮食日志管理，支持卡片/时间线/日历视图，标签分类统计 |
| 💡 脑暴笔记 | 灵感收集管理，支持卡片/时间线视图，快捷键快速添加 |
| 📋 任务记录 | 任务甘特图展示，拖拽进度管理，支持列表/甘特图视图 |
| 📚 文本收藏 | Markdown 文本收藏，分类管理，支持编辑/预览分离模式 |
